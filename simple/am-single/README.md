...
In this docker-compose resources, A single self-sign certificate was generated by defining *.am.wso2.com as a while card entry and adding a localhost as a SAN entry. This same certificate was used in both the Nginx load balancer (SSL configration) and the TLS keystore used for the APIM.
